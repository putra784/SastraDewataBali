...
$sqlUser = "SELECT COUNT(*) AS total_author FROM user WHERE role = 'author'";
$userResult = $conn->query($sqlUser);
$userCount = $userResult->fetch_assoc();
        ...
        <div class="flex-1 flex flex-col">
            ...
            <div class="flex gap-2 h-screen">
                <div
                    ...
                    <!-- User -->
                    <a href="user-handling.php" class="bg-blue-400 w-1/2 rounded-bl-xl p-6 flex flex-col text-black h-1/2 hover:shadow-2xl cursor-pointer">
                        <div class="flex justify-between items-center">
                            <p class="text-3xl font-light">
                                <?= $userCount['total_author'] ?? 0 ?>
                            </p>
                            <img
                                src="../assets/icon/user.svg"
                                class="w-10 opacity-60 invert" />
                        </div>
                        <p class="mt-auto tracking-wide">User</p>
                    </a>
