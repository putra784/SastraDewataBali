...
$posts = getFilteredPostsAdmin('pending', $show, $offset, $language, $category, $search);
$totalPosts = getFilteredTotalPostsAdmin('pending', $language, $category, $search);
        ...
        <div id="sidebar" class="w-[260px] bg-[#4e342e] text-white flex flex-col p-6 transition-all duration-300">
            ...
            <div class="mb-3">
                ...
                <div
                    ...
                    <a
                        href="pending.php"
                        class="px-4 py-2 text-sm bg-gray-300 border-b border-gray-500">Pending Posts</a>
                            ...
                            <?php foreach ($posts as $post): ?>
                                <tr class="border-b hover:bg-gray-50">
                                    ...
                                    <td class="px-3 py-2 border text-center">
                                        ...
                                        <form action="option/schedule-post.php" method="POST"
                                        ...
                                        <!-- Publish Now -->
                                        <form action="option/publish-post.php" method="POST" class="mt-2">
                                            <input type="hidden" name="id" value="<?= $post['id'] ?>">
                                            <button type="submit"
