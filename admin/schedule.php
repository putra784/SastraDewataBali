...
$posts = getFilteredPostsAdmin('scheduled', $show, $offset, $language, $category, $search);
$totalPosts = getFilteredTotalPostsAdmin('scheduled', $language, $category, $search);
        ...
        <div id="sidebar" class="w-[260px] bg-[#4e342e] text-white flex flex-col p-6 transition-all duration-300">
            ...
            <div class="mb-3">
                ...
                <div
                    ...
                    <a
                        href="pending.php"
                        class="px-4 py-2 text-sm bg-white border-b border-gray-500">Pending Posts</a>
                    <a href="schedule.php" class="bg-gray-300 px-4 py-2 text-sm hover:bg-gray-300 border-b border-gray-500">Schedule Posts</a>
                    <a
        ...
        <div class="flex-1 flex flex-col">
            ...
            <div class="w-full p-8">
                ...
                <div class="flex justify-between items-center mb-6">
                    <h1 class="text-2xl font-semibold tracking-wide">Pending Posts</h1>
                            ...
                            <?php foreach ($posts as $post): ?>
                                <tr class="border-b hover:bg-gray-50">
                                    ...
                                    <td class="px-3 py-2 border text-center">
                                        ...
                                        <!-- Tombol Show Schedule Form -->
                                        <button type="button"
                                            class="px-3 py-1 bg-yellow-500 text-white rounded text-xs hover:bg-yellow-600"
                                            onclick="toggleScheduleForm(<?= $post['id'] ?>)">
                                            Edit Schedule
                                        </button>

                                        <!-- Form Schedule (hidden by default) -->
                                        <form action="option/schedule-post-update.php" method="POST"
                                            id="schedule-form-<?= $post['id'] ?>"
                                            class="hidden mt-2 flex flex-col gap-2 items-center">
