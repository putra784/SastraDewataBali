...
$posts = getFilteredPostsAdmin('published', $show, $offset, $language, $category, $search);
$totalPosts = getFilteredTotalPostsAdmin('published', $language, $category, $search);
        ...
        <div id="sidebar" class="w-[260px] bg-[#4e342e] text-white flex flex-col p-6 transition-all duration-300">
            ...
            <div class="mb-3">
                ...
                <div
                    ...
                    <a href="schedule.php" class="px-4 py-2 text-sm hover:bg-gray-300 border-b bg-white border-gray-500">Schedule Posts</a>
                    <a
                        href="uploaded-post.php"
                        class="px-4 py-2 text-sm bg-gray-300 border-b border-gray-500">Uploaded Posts</a>
                </div>
            </div>
        </div>
        ...
        <div class="flex-1 flex flex-col">
            ...
            <div class="w-full p-8">
                ...
                <div class="flex justify-between items-center mb-6">
                    <h1 class="text-2xl font-semibold tracking-wide">Uploaded Posts</h1>
                </div>
                        ...
                        <tbody>
                            ...
                            <?php foreach ($posts as $post): ?>
                                <tr class="border-b hover:bg-gray-50">
                                    ...
                                    <td class="px-3 py-2 border text-center">
                                        <!-- Tombol Delete Post -->
                                        <form action="option/delete-post.php" method="POST" class="mt-2">
