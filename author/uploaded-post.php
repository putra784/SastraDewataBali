...
// ambil posts status published
$posts = getFilteredPosts('published', $_SESSION["user_id"], $show, $offset, $language, $category, $search);

// total records for pagination
$totalPosts = getFilteredTotalPosts('published', $_SESSION["user_id"], $language, $category, $search);
      ...
      <div class="mb-3">
        ...
        <div
          ...
          <a
            ...
            class="px-4 py-2 text-sm hover:bg-gray-300 border-b border-gray-500 bg-gray-300">Uploaded Post</a>
          <a
            href="pending.php"
