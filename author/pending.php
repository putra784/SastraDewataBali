...
// ambil posts status pending
$posts = getFilteredPosts('pending', $_SESSION["user_id"], $show, $offset, $language, $category, $search);

// total records for pagination
$totalPosts = getFilteredTotalPosts('pending', $_SESSION["user_id"], $language, $category, $search);
    ...
    <div class="w-[260px] bg-[#4e342e] text-white flex flex-col p-6">
      ...
      <div class="mb-3">
        ...
        <div
          ...
          <a
            href="pending.php"
            class="px-4 py-2 text-sm hover:bg-gray-300 border-b border-gray-500 bg-gray-300">Pending Posts</a>
